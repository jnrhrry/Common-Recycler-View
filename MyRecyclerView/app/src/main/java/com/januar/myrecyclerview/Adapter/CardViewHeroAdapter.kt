package com.januar.myrecyclerview.Adapter
...
import com.januar.myrecyclerview.Hero
import com.januar.myrecyclerview.R
    ...
    inner class CardViewViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        fun bind(hero: Hero){
            with(itemView){
                ...
                btn_set_share.setOnClickListener { Toast.makeText(itemView.context, "Share ${hero.description}", Toast.LENGTH_SHORT).show()}
